...
class StubComplaintService:
    ...
    def open_complaint(
        self, customer_id, category, description, channel="API", created_by="system"
    ) -> str:
...
class TestFosEscalation:
    def test_escalate_returns_200(self, client_with_stub):
        resp = client_with_stub.post(
            "/complaints/cid-003/escalate-fos",
            json={
    ...
    def test_escalate_calls_service(self, client_with_stub, stub_svc):
        client_with_stub.post(
            "/complaints/cid-004/escalate-fos",
            json={
