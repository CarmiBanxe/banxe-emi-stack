...
OPERATIONAL_ACCT   = os.environ.get("SAFEGUARDING_OPERATIONAL_ACCOUNT","019d6332-f274-709a-b3a7-983bc8745886")
CLIENT_FUNDS_ACCT  = os.environ.get("SAFEGUARDING_CLIENT_FUNDS_ACCOUNT","019d6332-da7f-752f-b9fd-fa1c6fc777ec")
...
def list_accounts():
    accounts = [
        {k: v for k, v in acct.items() if not k.startswith("_")}
