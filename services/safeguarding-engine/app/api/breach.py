...
async def get_breach(breach_id: str, service=Depends(get_breach_service)):
...
async def resolve_breach(breach_id: str, data: BreachResolve, service=Depends(get_breach_service)):
