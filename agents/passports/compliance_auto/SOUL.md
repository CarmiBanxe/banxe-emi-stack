...
**Cluster:** B-4 (Compliance / Reporting)  ·  **Trust Zone:** AMBER  ·  **Execution-class:** gated
**Decider (HITL, verbatim from `## HITL Gates`):** Compliance Officer (fca_breach_reporting, SUP 15.3)

### Core Algorithm: enumerate → score (MAUT) → satisfice within HITL → escalate
1. **Enumerate** feasible in-scope actions (compliance-automation checks / breach-report preparation) — no autonomous regulated disposition.
